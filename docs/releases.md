...
long as the build is green!) and push it on the registry as `camptocamp/enfinfidu_odoo:x.y.z`
...
* Paul tests the image `camptocamp/enfinfidu_odoo:9.4.0` and oops, it seems he
